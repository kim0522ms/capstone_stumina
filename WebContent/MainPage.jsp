...
<section class="main-slider">
  ...
  <div class="item image">
    <figure>
      <div class="slide-image slide-media" style="background-image:url('https://yeonjae.or.kr/files/attach/images/1623/055/002/f_4d241b2a6c77a.jpg');">
        <img data-lazy="https://yeonjae.or.kr/files/attach/images/1623/055/002/f_4d241b2a6c77a.jpg" class="image-entity" />
      </div>
		    		...
		    		for (StudyInfo studyinfo : studyInfos)
		    		{
		    			...
		    			<div class="ui card">
			      			...
			      			<div class="ui slide masked reveal">
			        			...
			        			%>
			        			<img src="${pageContext.request.contextPath}<%=path%>" class="visible content">
